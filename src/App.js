...
import ShowerTaskPage from "./components/tasks/ShowerTaskPage"; // Import ShowerTaskPage
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/task/shower" element={<ShowerTaskPage />} /> {/* Add route for ShowerTaskPage */}
      </Routes>
    </Router>
  );
}
